...
{ 
    public const char AddEventCommand = 'A';
    public const char DeleteEventCommand = 'D';
    public const char ListEventCommand = 'L';
    public const char ExitEventCommand = 'E';
    ...
    private static bool ExecuteNextCommand()
    {
        ...
        if (command[0] == AddEventCommand)
        {
            AddEvent(command);
            return true;
        }

        if (command[0] == DeleteEventCommand)
        {
            DeleteEvents(command);
            return true;
        }

        if (command[0] == ListEventCommand)
        {
            ListEvents(command);
            return true;
        }

        if (command[0] == ExitEventCommand)
        {
            return false;
        }
