...
namespace IntergalacticTravel.Tests.TStation
{
    ...
    public class Constructors_Should
    {
        ...
        public void SetUpAllFieldsProperly_WhenCreatedWithValidParameters()
        {
            ...
            var mockedTeleportStation = new FakeTeleportStation(mockedOwner.Object, mockedGalacticMap.Object, mockedLocation.Object);
            
            // Act and Assert
            Assert.IsInstanceOfType(mockedTeleportStation.Owner, typeof(IBusinessOwner));
            Assert.IsInstanceOfType(mockedTeleportStation.Resources, typeof(IResources));
            Assert.IsInstanceOfType(mockedTeleportStation.GalacticMap, typeof(IEnumerable<IPath>));
        }
