...
namespace E3.Maslan
{
    class Maslan
    {
        static void Main(string[] args)
        {
            ...
            int transformersCouter = 0;

            while (transformersCouter < 10 && 9 < n)
            {
            ...
            if (transformersCouter < 10)
            {
                Console.WriteLine(  transformersCouter);
            }
            //else if (transformersCouter > 10)
            //{
