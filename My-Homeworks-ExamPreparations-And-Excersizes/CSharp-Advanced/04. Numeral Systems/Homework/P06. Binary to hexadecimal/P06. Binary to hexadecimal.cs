...
namespace P06.Binary_to_hexadecimal
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string binStringNumber = Console.ReadLine();
            NumeralSystems nS = new NumeralSystems();

            ulong decNumber = nS.BinaryToDecimal(binStringNumber);
            string hexString = nS.DecimalToHex(decNumber);
